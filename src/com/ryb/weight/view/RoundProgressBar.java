...
public class RoundProgressBar extends View
{
	 ...
	 * 圆环中的上面一行的字符
	 */
	private String textTop = "default";
	
	/**
	 * 圆环中的下面一行的字符
	 */
	private String textBottom = "default";
	...
	protected void onDraw(Canvas canvas)
	{
		...
		//if (textIsDisplayable  && style == STROKE)
		{
			...
			canvas.drawText(textTop, centre - textWidth / 2, centre + textSize / 2, paint); // 画出进度百分比
			canvas.restore();
			textWidth = paint.measureText(textBottom);
			canvas.save();
			canvas.translate(0, textSize);
			canvas.drawText(textBottom, centre - textWidth / 2, centre + textSize / 2, paint);
			canvas.restore();
		}
